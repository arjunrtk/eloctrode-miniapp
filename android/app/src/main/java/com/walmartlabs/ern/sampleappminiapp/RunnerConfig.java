package com.walmartlabs.ern.sampleappminiapp;

import com.walmartlabs.ern.container.miniapps.SampleappMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = SampleappMiniappActivity.class;
